...
Pools are predefined limits set at the engine level, determining the maximum number of players, vehicles, objects, or other entities that can be created and active in the game simultaneously.
