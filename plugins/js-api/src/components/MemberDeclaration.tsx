...
import {Comment, hasComment, isReflectionDeprecated} from './Comment';
...
export function MemberDeclaration({ id }: MemberDeclarationProps) {
	...
	const deprecated = isReflectionDeprecated(reflection);

	return (
		<>
			<div className="tsd-panel-content">
				<div className={`tsd-signature tsd-kind-icon ${deprecated ? 'tsd-deprecated' : ''}`}>
